...
[![Tests](https://img.shields.io/badge/Tests-143%20passing-22C55E)](#测试与验证)
...
| 终章 Boss 首版 | 第 100 关顶点裁决者：可击碎闸门的熔锁牢笼、留安全列的雷幕弹雨、锁定路径的高速镜冲、先牵引后爆发的引力漩涡；按四种机制逐一充能封印 |
...
顶点裁决者有 216 点生命。牢笼灌火 26、弹雨 16、镜冲 32、引力爆发 24 点伤害，各自有提前预警和不同的反制条件；四印点亮后核心开放 6 回合，首次窗口未击败则进入轮换招式并再次开窗。房内提供 3 个血包、3 个能量弹匣、弓和 2 组箭束；默认混合策略与规则策略均已通过固定场景无伤通关测试。**这仍是终章首版**：同屏双法则合招、Boss 独立弹体/受击/死亡逐帧动画及专属胜利结算仍在[制作规划](JEV_ARENA_BOSS_ROADMAP.md)中。

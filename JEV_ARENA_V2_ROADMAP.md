...
- [ ] 新增独立 EnemyType 与高速移动 Intent
- [ ] 每次沿可见路径移动 2 格，允许转弯但不能穿墙、踩火、踩刺或跳坑
- [ ] 低 HP（建议 16~18），贴身后下一次 Intent 才攻击，禁止移动后同拍咬人
- [ ] 第 5 关开始出现；前期最多 1 只，后期最多 2 只
- [ ] Observation / Candidate 输出两格移动路径和终点威胁
- [ ] Renderer 增加高速残影与路径预警
- [ ] 固定场景测试：绕墙、避火、不堵死玩家、不给出生杀

...
第 20 关熔炉三头机已有首版可玩战斗：火球与熔岩波独立预警、三座冷却阀破盾、比第 10 关更大的锻炉形房间、熔岩边道、弓箭与血包补给；规则代理及默认 NanoJev 混合策略均通过固定场景无伤通关验证。第 30 关风暴合唱环也已接入错位接地柱、导电位、连锁闪电与高压雷爆，默认 NanoJev 混合策略通过本地 checkpoint 无伤通关。第 40～100 关尚未实装。

下一只实装目标为第 40 关“时序螳螂”：高速横切、带完整落点预告的跃迁、时间锚固定残影反杀。具体速度上限、伤害、场地和验收条件见 `JEV_ARENA_BOSS_ROADMAP.md`；目前仅完成设定与静态素材，不能当作已可玩的 Boss。

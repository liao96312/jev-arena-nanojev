...
第 20 关熔炉三头机已加入半血后二阶段：三列熔岩波、短暂燃烧格和开放窗口换位；火球与熔岩波独立预警、三座冷却阀破盾、大锻炉房间、熔岩边道、弓箭与血包补给均已接入，规则代理及默认 NanoJev 混合策略通过固定场景无伤通关验证。第 30 关风暴合唱环现有 132 点生命、错位接地柱和连锁闪电；降至三分之二血量后导电位移到两翼，雷爆伤害提高但范围不变，默认混合策略通过固定场景无伤通关。第 40 关时序螳螂现有横切、锁定近斩、预告跃迁、时间锚破盾与二阶段锚点后移。第 50 关虚空钓手已接入暗色异形房、引力雷/锁定光束、三节点吸离装甲与破盾输出窗口。第 60 关钢铁园丁已接入两轮生长的荆棘墙、焚烧线/荆棘爆发、四根盘热回流破盾。第 70 关镜像炽天使已接入延迟复制、镜像方向预警、三镜锁破盾与局部沉默。第 80 关攻城利维坦已接入双回合轨道炮、可移动/重建掩体、四锁破盾。第 90 关归零织机已接入四类动作轮换封锁、两回合预警的临时断裂地板和四个编号节点破盾。第 100 关顶点裁决者首版已接入熔锁牢笼、雷幕弹雨、镜面冲撞与引力漩涡，四印破盾后开放核心；规则代理和默认混合策略均通过固定场景无伤通关。第 10～100 关 Boss 房轮廓与补给组合不重复；终章同屏合招、独立弹体和专属结算尚未实装。

第 40 关已补按玩家横向站位换侧、分段横切、跃迁蓄力前压、二阶段时间锚后移与核心开放时换位；弹药耗尽可近战补刀。下一步是绕掩体的深度追击、更多佯攻与残影组合。当前仍主要沿两条侧翼移动，具体制作标准见 `JEV_ARENA_BOSS_ROADMAP.md`。
